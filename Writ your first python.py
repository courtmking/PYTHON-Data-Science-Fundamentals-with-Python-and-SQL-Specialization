...
print('Hello, Billybob!') # This line prints a string
# print('Hi')
...
print(ifithadntbeenforcottoneyedjoeidbemarriedalongtimeago) this line 


# In[6]:


print(ifithadntbeenforcottoneyedjoeidbemarriedalongtimeago)
